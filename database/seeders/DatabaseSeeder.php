...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $memoires_theses = [
            ['loge_id' => 1, 'type_document_id' => 1, 'mention' => 'Mention Bien', 'cote' => "MEM E EFI SIN", 'theme' => "Dépenses publiques en insfrastructures routières et croissance économique au Bénin", 'auteur' => "SINAGORIGUI Loukoumane", "encadreur" => "Dr Mohamed PARAPE", "option_id" => 6, "annee" => "2019", "exemplaire" => 2],
            ['loge_id' => 1, 'type_document_id' => 1, 'mention' => 'Mention Bien', 'cote' => "MEM E EFI SEG", 'theme' => "Analyse de la nature et du volume des échanges commerciaux entre le Bénin et le Niger", 'auteur' => "SEGNON Wiliam", "encadreur" => "Dr Camille GUIDIME", "option_id" => 6, "annee" => "2020", "exemplaire" => 2],
            ['loge_id' => 1, 'type_document_id' => 1, 'mention' => 'Mention Bien', 'cote' => "MEM E EFI SEK", 'theme' => "Libéralisation commerciale et pauvreté au Bénin", 'auteur' => "SEKE KORA Abdel Fadel Mora", "encadreur" => "Dr Mathieu AVOUTOU", "option_id" => 6, "annee" => "2019", "exemplaire" => 2],
            ['loge_id' => 1, 'type_document_id' => 1, 'mention' => 'Mention Bien', 'cote' => "MEM E EFI SAL", 'theme' => "Facteurs Sociaux Economiques des investissements dans la production cotonière dans la commune de Kérou", 'auteur' => "SALIFOU Nazif TOURE", "encadreur" => "Dr Jacob AFOUDA YABI", "option_id" => 6, "annee" => "2019", "exemplaire" => 2],
            ['loge_id' => 2, 'type_document_id' => 1, 'mention' => 'Mention Bien', 'cote' => "MEM EPI GBA", 'theme' => "Facteurs associés à l'utilisation des moustiquaires impregnées à longue durée (MILD) dans la commune de Cobly en 2014", 'auteur' => "Gwladys Nadia GBAGUIDI", "encadreur" => "Pr Dismand HOINATO", "option_id" => 1, "annee" => "2014", "exemplaire" => 2],
            ['loge_id' => 2, 'type_document_id' => 1, 'mention' => 'Mention Bien', 'cote' => "MEM EPI SIK", 'theme' => "Facteurs associés au don volontaire de sang en population générale à Parakou (Bénin) en 2015", 'auteur' => "Choucouratou SIKARO", "encadreur" => "Dr Georgia B. DAMIEN", "option_id" => 1, "annee" => "2014", "exemplaire" => 2],
            ['loge_id' => 3, 'type_document_id' => 3, 'mention' => 'Mention Bien', 'cote' => "THE MED KOU", 'theme' => "Morbidité oculaire en milieu universitaire à Parakou", 'auteur' => "Evard KOUTCHORO", "encadreur" => "Pr Ag Ignance SOUNOUVOU", "option_id" => 15, "annee" => "2013", "exemplaire" => 2],
            ['loge_id' => 3, 'type_document_id' => 3, 'mention' => 'Mention Bien', 'cote' => "THE MED DAN", 'theme' => "Evaluation du traitement chirurgical de l'Ulcère de Buruli au Centre Sanitaire et Nutritionel Gbemontin de Zagnanado de 2006 a 2008", 'auteur' => "Houénoukpo Armand DANDJLESSA", "encadreur" => "Pr Ag Jean Léon OLORY TOGBE", "option_id" => 15, "annee" => "2012", "exemplaire" => 2],
            ['loge_id' => 3, 'type_document_id' => 3, 'mention' => 'Mention Bien', 'cote' => "THE MED DJO", 'theme' => "Diamètres échographiques de l'aorte abdominale dans une population a rique d'anévrysme en milieu hospitalier à Parakou en 2014", 'auteur' => "Mahunan Jaurès DJOCHOU", "encadreur" => "Pr Martin Dèdonougbo HOUENASSI", "option_id" => 15, "annee" => "2012", "exemplaire" => 2],
            ['loge_id' => 3, 'type_document_id' => 3, 'mention' => 'Mention Bien', 'cote' => "THE MED KPA", 'theme' => "Aspects épidémiologiques, cliniques et évolutifs du paludisme neonatal au Centre Hospitalier Départemental du Borgou (CHD-B) en 2014", 'auteur' => "Jean-marie Vianey KPADONOU", "encadreur" => "Pr Titulaire Simon AKPONA", "option_id" => 15, "annee" => "2014", "exemplaire" => 2],
            ['loge_id' => 3, 'type_document_id' => 3, 'mention' => 'Mention Bien', 'cote' => "THE MED TOI", 'theme' => "Evaluation de la prise en charge de la sinusite aigue de l'adulte par les médecins généralistes du Nord-Bénin en 2019", 'auteur' => "Kpèssou Mahuwèdo Lucrèce TOI", "encadreur" => "Dr Spéro HOUNKPATIN", "option_id" => 15, "annee" => "2014", "exemplaire" => 2],
        ];
