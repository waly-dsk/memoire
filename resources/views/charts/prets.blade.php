...
@section('title', 'Graphe Prêts Livres Imprimés')
@section('content')
    ...
    <div class="row">
        <div class="col-lg-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Mois de Prêts </h4>
                    <p class="card-description">
                        Les <code> Mois de Prêts </code> du <code>Plus Récent au Plus Ancien</code>
                    </p>
                    <hr>
    ...
    <script>
        $(function() {
            ...
            function load_charts(mois) {
                ...
                $.get('{{ url('get_prets') }}/' + mois, function(items) {
                    labels = [];
                    datum = [];
                    backgroundColors = [];
                    borderColors = [];
                    items.forEach(item => {
                        labels.push(item.classe);
                        datum.push(item.nombre_prets);
